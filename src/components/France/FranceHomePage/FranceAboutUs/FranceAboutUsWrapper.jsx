...
const FranceAboutUsWrapper = () => {
  ...
  const icons = [
    { id: 1, txt: "Customized Marketing Solutions", icon: GiStumpRegrowth },
    { id: 2, txt: "Expertise in SEO & Design", icon: RiTeamFill },
    { id: 3, txt: "Data-Driven Strategies", icon: FaUserFriends },
    { id: 4, txt: "ROI-Focused Dedicated Team", icon: FaBullhorn },
  ];
  return (
